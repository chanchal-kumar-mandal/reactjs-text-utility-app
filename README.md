## Description
This is Reactjs Text utilyze application. We can convert uppercase, lowercase, cahr code, clear entered text. We can render diffrent page content (Home/About Us) without page reload. We toggles color, bg-color in about us page using.
